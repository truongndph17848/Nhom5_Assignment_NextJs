    ...
    <div>
        ...
        <div className="container">
            ...
            <div className="w-full lg:w-1/2 xl:w-6/12 px-4">
                ...
                <p className="text-base text-body-color font-mono leading-relaxed mb-9">
                    BẠN ĐANG TÌM KIẾM NHỮNG MẪU THỜI TRANG, QUẦN ÁO VÀ PHỤ KIỆN MỚI NHẤT TRÊN MẠNG? HÃY MUA SẮM NGAY HÔM NAY TẠI LOGO SHOP!
                </p>
                <div className="flex mb-8 max-w-[370px] w-full">
                    ...
                    <h4 className="font-bold text-dark text-xl mb-1">Địa chỉ</h4>
                    <p className="text-base text-body-color">
                        86 Dương Quang Hàm, Cầu Giấy, Hà Nội
                    </p>
                    </div>
                </div>
                <div className="flex mb-8 max-w-[370px] w-full">
                    ...
                    <div className="w-full">
                    <h4 className="font-bold text-dark text-xl mb-1">Số điện thoại</h4>
                    <p className="text-base text-body-color">0336.833.688</p>
                    </div>
                </div>
                <div className="flex mb-8 max-w-[370px] w-full">
                    <div className="
                    ...
                    <p className="text-base text-body-color">logo@shop.com</p>
                    </div>
                </div>
                </div>
            </div>
            <div className="w-full lg:w-1/2 xl:w-5/12 px-4">
                ...
                <form>
                    ...
                    <div className="mb-6">
                    <textarea rows={6} placeholder="Mội dung" className="
                        w-full
                        rounded
                        py-3
                        px-[14px]
...
Contact.WebsiteLayout = WebsiteLayout
