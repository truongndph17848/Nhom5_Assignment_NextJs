        ...
        <div className="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-6 py-3">
          ...
          >
            <div className="order-1 md:order-2">
              ...
              >
                <img
                  src="https://bizweb.sapocdn.net/100/438/408/themes/863105/assets/logo.svg?1659776192549"
                  alt=""
                  width={100}
                  height={150}
                />
          ...
          <div
            className="order-3 md:order-4 flex items-center"
            id="nav-content"
          >
            <Link href="/cart">
      ...
      <footer className="p-4 bg-white sm:p-6 dark:bg-gray-800">
              ...
              <ul>
                <li className="mb-4">
                  <a
                    ...
                    className="text-gray-600 hover:underline dark:text-gray-400"
                  >
                    Địa chỉ: 86 Dương Quang Hàm, Cầu Giấy, Hà Nội
                  </a>
                </li>
                <li>
                  <a
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">
            © 2022 LOGO SHOP™. All Rights Reserved.
          </span>
